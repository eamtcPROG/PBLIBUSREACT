      ...
      <Row style={{ marginTop: '5%' }}>
        ...
        >
          ...
          >
            ...
            >
              <Input placeholder="Number seats" style={{ width: "100%" }} onChange={handleNumberSeatsChange} value={numberseats} />
            </Form.Item>
            ...
            >
              <Input style={{ width: "100%" }} placeholder="Plate" onChange={handlePlateChange} value={plate} />
            </Form.Item>
            <Form.Item // Form Item (Email)
